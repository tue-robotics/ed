                                         ...
                                         ALMResult& result)
{
    ...
    if (visualize_) {
        //        helpers::visualization::publishNpclVisualizationMarker(sensor_data.sensor_pose, world_model_npcl, vis_marker_pub_, 1, "world_model_npc");
        helpers::visualization::publishPclVisualizationMarker(sensor_data.sensor_pose, world_model_pcl_downsampled, vis_marker_pub_, 1, "world_model_pc");
    }
