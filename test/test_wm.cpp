...
void buildWorldModel(ed::WorldModel& wm)
{
    ...
    boost::shared_ptr<ed::TransformCache> const t1(new ed::TransformCache());
    t1->insert(0, geo::Pose3D(1, 2, 3, 0, 0, M_PI / 2));
    req.setRelation("map", "table", t1);

    boost::shared_ptr<ed::TransformCache> const t2(new ed::TransformCache());
...
void profile(const ed::WorldModel& wm)
{
    ...
    ed::UUID const id1 = "map";
    ed::UUID const id2 = "e100";
